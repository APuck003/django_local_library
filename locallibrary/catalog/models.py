...
class Book(models.Model):
    ...
    # ManyToManyField used because genre can contain many books. Books can also cover many genres.
...
class BookInstance(models.Model):
    ...
    due_back = models.DateField('Due Date', null=True, blank=True)
...
class Genre(models.Model):
    ...
    name = models.CharField(max_length=200, help_text="Enter a book genre (e.g. Fiction, Non-Fiction, Fantasy, "
                                                      "Science Fiction, etc.)")
...
#     """Model representing a language (e.g. English, Spanish, Japanese, etc.)"""
