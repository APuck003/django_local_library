...
class AuthorListViewTest(TestCase):
    ...
    def test_lists_all_authors(self):  # Get second page and confirm it has exactly 3 remaining items
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertFormError(resp, 'form', 'renewal_date', 'Invalid date. Renewal is in the past.')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertFormError(resp, 'form', 'renewal_date', 'Invalid date. Renewal is more than 4 weeks ahead.')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirects_to_detail_view_on_success(self):
        login = self.client.login(username='testuser2', password='12345')
        resp = self.client.post(reverse('author_create'), {'first_name': 'Christian Name',
                                                           'last_name': 'Surname', })
