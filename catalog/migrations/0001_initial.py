# Generated by Django 2.0.1 on 2018-04-17 01:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (e.g. Fiction, Non-Fiction, Fantasy, Science Fiction, etc.)', max_length=200)),
            ],
        ),
        migrations.AddField(
            model_name='book',
